...
.lab_selector <- function(lab, lab_titles) {
  ...
  lab_urls <- paste0('https://raw.githubusercontent.com/ThinkDataEd/labs/master/',
                     .format_lab_title(lab_titles), '.html')
...
load_pd <- function(lab) {
  ...
  lab_urls_A <- paste0('https://raw.githubusercontent.com/ThinkDataEd/labs/master/',
  ...
  lab_urls_B <- paste0('https://raw.githubusercontent.com/ThinkDataEd/labs/master/',
  ...
  if (assertthat::is.string(lab)) {
	url <- paste0('https://raw.githubusercontent.com/ThinkDataEd/labs/master/',
