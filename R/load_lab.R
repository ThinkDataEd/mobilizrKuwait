...
.lab_selector <- function(lab, lab_titles) {
  ...
  lab_urls <- paste0('https://raw.githubusercontent.com/IDSUCLA/ids_labs2/master/',
                     .format_lab_title(lab_titles), '.html')
...
load_pd <- function(lab) {
  ...
  lab_urls_A <- paste0('https://raw.githubusercontent.com/IDSUCLA/ids_labs2/master/',
  ...
  lab_urls_B <- paste0('https://raw.githubusercontent.com/IDSUCLA/ids_labs2/master/',
  ...
  if (assertthat::is.string(lab)) {
	url <- paste0('https://raw.githubusercontent.com/IDSUCLA/ids_labs2/master/',
